...
LAUNCH_ENTRIES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "confidence": "verified",
        "aliases": (
            ("gpt-6-astra", "api_model_id"),
            ("gpt-6-astra", "bare_name"),
            ("gpt-6", "api_model_id"),
            ("gpt-6", "bare_name"),
            ("GPT-6 Astra", "display_name"),
            ("GPT-6", "display_name"),
            ("gpt-6-astra-aeon", "api_model_id"),
            ("gpt-6-astra-pro", "api_model_id"),
            ("openai/gpt-6-astra", "router_id"),
        ),
        "evidence": {
            "source_url": "https://x.com/scaling01/status/2095579734813937942",
            "release_date": "2026-09-03",
            "class": "Next-generation flagship reasoning model trained on >100,000 GPUs at Stargate Texas.",
            "access": "Rolling out initially to Daybreak Access enterprise customers, then ChatGPT Plus, Pro, Business, Enterprise, and API (gpt-6-astra).",
            "pricing_standard": {
                "input_per_1m": 10.00,
                "output_per_1m": 50.00,
            },
            "pricing_docs_url": "https://thenewstack.io/openai-gpt6-astra-benchmarks/",
            "architecture": "Largest training run to date; pre-trained on more than 100,000 GPUs at Stargate site in Texas; previous models heavily supervised training.",
            "training_run": "100k+ GPUs Stargate Texas",
            "preparedness_rating": "Critical on OpenAI Preparedness Framework cybersecurity capability.",
            "docs_url": "https://thenewstack.io/openai-gpt6-astra-benchmarks/",
        },
    },
)
